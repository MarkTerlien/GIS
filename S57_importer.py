...
#                    self.oracle_cursor.execute( stmt, { '1' : str(spatial_type) + str(key), '2' : geom_clob } )
                ...
                for key in spat_dict :
                    ...
                    spat = spat_dict[key]
                    node_geom = ogr.CreateGeometryFromWkt(spat[GEOMETRY])
                    spat_list.append ( (str(spatial_type) + str(key), node_geom.GetX(0), node_geom.GetY(0)  ) )
                    nr_spatials = nr_spatials + 1
        ...
        try:
            ...
            for feature_type_dict in features_list :
                for feature_id in feature_type_dict :
                    ...
                    feature_insert_list.append( ( feature_id, object_class_id,  feature_gtype ) ) 
...
#            self.oracle_cursor.executemany(None, feature_insert_list)   
            ...
            for attribute_insert in attribute_string_list :
